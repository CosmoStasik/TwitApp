...
struct PostCardView: View {
    ...
    var body: some View {
        ...
        .overlay(alignment: .topTrailing, content: {
            // Displainp Delete Button (if its Author of the post)
            ...
            .onDisappear{
                // MARK: Applying Snapshot Listner Only When the post is Avaible on the Screen
                // Else Removing the Listner( it saves unwanted live updates from the posts whitch was swipped away from the screen)
                if let docListner{
                    docListner.remove()
                    self.docListner = nil
                }
